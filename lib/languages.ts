...
export const getLanguages = (value: AppLanguage | string = 'eng') => {
    const eng = {
        base: {
            ...
            avatarUploadError: 'Something went wrong uploading the photo. Please try again.',
            Wiki: 'Wiki',
            ...
            trainerBadgeTierIron: 'Iron',
            trainerBadgeTierBronze: 'Bronze',
            trainerBadgeTierSilver: 'Silver',
            trainerBadgeTierGold: 'Gold',
            trainerBadgeClientsCount: '{value} clients',
    ...
    const rus = {
        base: {
            ...
            avatarUploadError: 'Не удалось загрузить фото. Попробуйте ещё раз.',
            Wiki: 'Wiki',
            ...
            alreadyRegisteredError: 'Эта почта уже зарегистрирована. Попробуйте войти вместо регистрации.',
            confirmEmailBody: 'Мы отправили ссылку для подтверждения на {value}. Проверьте почту и перейдите по ссылке перед входом.',
            allUsers: 'Все пользователи',
            searchUsers: 'Поиск пользователей',
            noUsersMatch: 'Нет пользователей по запросу «{value}».',
            searchFriends: 'Поиск друзей',
            noFriendsMatch: 'Нет друзей по запросу «{value}».',
            edit: 'Редактировать',
            save: 'Сохранить',
            ...
            deleteAccountConfirmMessage: 'Это навсегда удалит ваш профиль, программы, историю тренировок и уберёт вас из списков друзей/тренеров. Это действие нельзя отменить.',
            ...
            trainerLabel: 'Тренер',
            trainerBadgeTierIron: 'Железо',
            trainerBadgeTierBronze: 'Бронза',
            trainerBadgeTierSilver: 'Серебро',
            trainerBadgeTierGold: 'Золото',
            trainerBadgeClientsCount: '{value} подопечных',
        ...
        settings: {
            ...
            locationSection: 'Место проживания',
            cityPlaceholder: 'Начните вводить город…',
            detectLocation: 'Определить автоматически',
            noMatches: 'Города не найдены',
            locationError: 'Не удалось определить вашу локацию',
        },
        training: {
            ...
            programViewIcons: 'Вид иконками',
            programViewText: 'Текстовый вид',
            rotateScreen: 'Повернуть экран',
            rotateHint: 'Поверните телефон вручную',
            aerobic: 'Аэробная',
    ...
    const ua = {
        base: {
            ...
            avatarTooLarge: 'Зображення завелике (макс. 5МБ).',
            avatarUploadError: 'Не вдалося завантажити фото. Спробуйте ще раз.',
            Wiki: 'Wiki',
            ...
            alreadyRegisteredError: 'Ця пошта вже зареєстрована. Спробуйте увійти замість реєстрації.',
            confirmEmailBody: 'Ми надіслали посилання для підтвердження на {value}. Перевірте пошту і перейдіть за посиланням перед входом.',
            ...
            noFriendsMatch: 'Немає друзів за запитом «{value}».',
            edit: 'Редагувати',
            save: 'Зберегти',
            ...
            deleteAccountConfirmTitle: 'Видалити ваш акаунт?',
            deleteAccountConfirmMessage: 'Це назавжди видалить ваш профіль, програми, історію тренувань і прибере вас зі списків друзів/тренерів. Цю дію не можна скасувати.',
            ...
            pending: 'Очікує',
            removeTrainer: 'Видалити тренера',
            removeClient: 'Видалити клієнта',
            clientsLabel: 'Клієнти',
            trainerLabel: 'Тренер',
            trainerBadgeTierIron: 'Залізо',
            trainerBadgeTierBronze: 'Бронза',
            trainerBadgeTierSilver: 'Срібло',
            trainerBadgeTierGold: 'Золото',
            trainerBadgeClientsCount: '{value} підопічних',
        ...
        settings: {
            ...
            locationSection: 'Місце проживання',
            cityPlaceholder: 'Почніть вводити місто…',
            detectLocation: 'Визначити автоматично',
            noMatches: 'Міст не знайдено',
            locationError: 'Не вдалося визначити вашу локацію',
        },
        training: {
            ...
            programViewIcons: 'Вигляд іконками',
            programViewText: 'Текстовий вигляд',
            rotateScreen: 'Повернути екран',
            rotateHint: 'Поверніть телефон вручну',
            aerobic: 'Аеробна',
            anaerobic: 'Анаеробна',
            crossfit: 'Кроссфіт',
    ...
    const pl = {
        base: {
            ...
            avatarTooLarge: 'Zdjęcie jest zbyt duże (maks. 5MB).',
            avatarUploadError: 'Nie udało się przesłać zdjęcia. Spróbuj ponownie.',
            Wiki: 'Wiki',
            ...
            alreadyRegisteredError: 'Ten e-mail jest już zarejestrowany. Spróbuj się zalogować.',
            confirmEmailBody: 'Wysłaliśmy link potwierdzający na {value}. Sprawdź skrzynkę i kliknij link przed zalogowaniem.',
            ...
            noFriendsMatch: 'Brak znajomych pasujących do "{value}".',
            edit: 'Edytuj',
            save: 'Zapisz',
            none: 'Brak',
            ...
            deleteAccountConfirmTitle: 'Usunąć Twoje konto?',
            deleteAccountConfirmMessage: 'To trwale usunie Twój profil, programy, historię treningów i usunie Cię z list znajomych/trenerów. Tej czynności nie można cofnąć.',
            ...
            pending: 'Oczekuje',
            removeTrainer: 'Usuń trenera',
            removeClient: 'Usuń klienta',
            clientsLabel: 'Klienci',
            trainerLabel: 'Trener',
            trainerBadgeTierIron: 'Żelazo',
            trainerBadgeTierBronze: 'Brąz',
            trainerBadgeTierSilver: 'Srebro',
            trainerBadgeTierGold: 'Złoto',
            trainerBadgeClientsCount: '{value} podopiecznych',
        ...
        settings: {
            ...
            locationSection: 'Miejsce zamieszkania',
            cityPlaceholder: 'Zacznij wpisywać miasto…',
            detectLocation: 'Wykryj automatycznie',
            noMatches: 'Nie znaleziono miast',
            locationError: 'Nie udało się wykryć Twojej lokalizacji',
        },
        training: {
            ...
            programViewIcons: 'Widok ikon',
            programViewText: 'Widok tekstowy',
            rotateScreen: 'Obróć ekran',
            rotateHint: 'Obróć telefon ręcznie',
            aerobic: 'Aerobowy',
