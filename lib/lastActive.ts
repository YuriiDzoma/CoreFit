...
// profile "Зареєстрований" line) already hardcodes Ukrainian-locale
// formatting regardless of the selected app language. This follows that
// precedent.
...
export function formatLastActive(lastActiveAt: string | null | undefined): LastActive | null {
